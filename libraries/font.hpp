...
Font::Font(char const* path) {
    ...
    glAttachShader(this->id, LoadShader(GL_VERTEX_SHADER, "shaders/text-ft-vertex.glsl"));
    glAttachShader(this->id, LoadShader(GL_FRAGMENT_SHADER, "shaders/text-ft-fragment.glsl"));
